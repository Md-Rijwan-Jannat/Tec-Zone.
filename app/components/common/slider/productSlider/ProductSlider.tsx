...
const ProductSlider: React.FC = () => {
  ...
  const text =
    "text-gray-900 bg-gray-100 px-2 py-1 rounded-md flex item-center gap-3 md:gap-5 text-[12px] md:text-[14px]";
    ...
    <div className="flex flex-col justify-between lg:flex-row gap-16 lg:items-center">
      <div className="flex flex-col gap-6 lg:w-2/4">
        <Image
          ...
          width={500}
          height={500}
          className="w-full md:w-[300px] lg:w-[400px] aspect-square object-cover rounded-xl"
        />
      ...
      <div className="flex flex-col gap-4 lg:w-2/4">
        ...
        <div className=" flex items-center flex-wrap gap-5 md:gap-7 space-y-0">
          ...
          <p className={text}>
            Product Code:{""}{" "}
            <span className="font-bold text-black">{"KFce"}</span>
          </p>
        </div>
